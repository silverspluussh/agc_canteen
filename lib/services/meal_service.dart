      ...
      if (mealTypeObj != null) {
        ...
        await _db.insertMealType(
          MealTypesCompanion(
            ...
            beginTime: Value(
              hasBeginTime
                  ? (mealTypeObj['beginTime'] as String? ?? mealTypeObj['begin_time'] as String? ?? existing?.beginTime ?? '00:00:00')
                  : (existing?.beginTime ?? '00:00:00'),
            ),
            endTime: Value(
              hasEndTime
                  ? (mealTypeObj['endTime'] as String? ?? mealTypeObj['end_time'] as String? ?? existing?.endTime ?? '23:59:59')
